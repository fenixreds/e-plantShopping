...
import { addItem, countTotalItems } from './CartSlice';
    ...
    return (
        <div>
            ...
            <div style={styleObjUl}>
                ...
                <text id="numeroSobreImagen" x="130" y="130" font-size="100" fill="black" text-anchor="middle" alignment-baseline="middle">{totalItems}</text></svg></h1></a></div>
            </div>
        </div>
        {!showCart? (
